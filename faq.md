...
### What is Ampt's pricing model?
Ampt offers a per developer per seat pricing model, allowing you to access our tools including the SDK, CLI, and Dashboard. In addition, we provide a platform-as-a-service (PaaS) for hosting your applications on Ampt, leveraging AWS accounts that we manage on your behalf.

### How does the free hosting tier work?
Ampt's free hosting tier offers developers a platform experience at no cost, with specific quotas on various resources:

- Included Quotas: Our free tier includes set limits on invocations, compute minutes, bandwidth, data storage, and file storage.
- Preview Plan Limits: For users on the Preview Plan, stricter quotas apply. This means you might reach the limits faster compared to our paid plans.
- Upgrading to a Paid Plan: By moving to a paid plan, you'll enjoy increased limits within the free tier, giving you more room for your projects.
- Exceeding Quotas: When you exceed any of the set limits, metered billing comes into play. This means you'll be billed separately for the additional resources you use.

For a detailed breakdown of our hosting costs and specific quotas, see our hosting pricing here.

### Can I upgrade or downgrade my plan any time?
Absolutely! At Ampt, we want to ensure you have the flexibility to choose what's best for your team at any given time:

- Upgrading Your Plan: When you choose to upgrade, the changes will take effect immediately, letting you access the enhanced capabilities right away.
- Downgrading Your Plan: We understand that your needs might change. If you decide to go for a simpler plan, the change will be processed at the beginning of your next billing cycle. This gives you time to adjust and ensures you still enjoy the benefits of your current plan until then.

### Is there a trial period for any of the paid plans?
Currently, we offer the Preview Plan which allows you to explore some functionalities of Ampt for free. For more comprehensive features, you can consider upgrading to our Developer or Team Plans.

### Can I limit my spend on hosting applications?
We are working on the spent caps for now. You will be able to put a cap on the resource usage soon. 

### What do you mean by "long-running tasks" in the Team Plan?
Long-running tasks refer to processes or operations that take more than 5 minutes to complete. The Team Plan unlocks these tasks more effectively than other plans.

### What happens if I reach the limit on the number of developers for a plan?
If you reach the maximum number of developers allowed on your plan, you'll need to upgrade to accommodate more team members.

### How do I manage the AWS accounts that Ampt uses on my behalf?
You don't need to worry about the AWS accounts when you’re in Preview, Developer, and Team plans. We manage these on your behalf, ensuring your applications run smoothly on our platform.

### Can I use my own AWS account with Ampt?
Absolutely. If you wish to integrate your own AWS account, we'll need to set up a new AWS account under your organization. Once that's done, you'll have the flexibility to direct any environment of your application to your own AWS account.

For optimal results and ease of management, we recommend using your own AWS account for production instances. It's more practical to keep developer sandboxes and preview environments hosted on Ampt. 

Contact us via sales@getampt.com to discuss using your AWS account. 

### What counts as an invocation in Ampt?
An invocation in Ampt refers to the execution of specific handler, such as triggering API endpoints, data change handlers, storage change handlers, or event handlers. Each time any of these handlers run, it's counted as a single invocation. However, loading static assets is not considered an invocation and won't be counted towards your usage.

### How do I get support if I have questions about my bill or pricing?
Our support team is available to assist you with any billing or pricing concerns. You can reach out to us via sales@getampt.com or via Discord.
